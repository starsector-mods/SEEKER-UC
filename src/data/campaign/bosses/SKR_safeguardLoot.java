...
//            Global.getSector().getMemory().set("$SKR_safeguard",true);
            ...
            SKR_plagueDossierIntel.get().unlockEntry("SAFEGUARD");
            ...
            if (loc != null) {
                ...
                if (wrecks != null && !wrecks.isEmpty()) {
                    for (SectorEntityToken t : wrecks) {
                        if (t.getCustomEntitySpec() != null && t.getCustomEntitySpec().getSpriteName() != null && t.getCustomEntitySpec().getSpriteName().startsWith("SKR_keep")) {
                            loc.removeEntity(t);
                            break;
                        }
                    }
