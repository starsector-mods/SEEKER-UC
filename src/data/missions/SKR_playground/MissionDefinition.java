...
public class MissionDefinition implements MissionDefinitionPlugin {
    ...
    public void defineMission(MissionDefinitionAPI api) {
        ...
        // Set up the player's fleet (One unique hull each)
        // Frigates & Gunships
        ...
        api.addToFleet(FleetSide.PLAYER, "SKR_follower_standard", FleetMemberType.SHIP, false);
        api.addToFleet(FleetSide.PLAYER, "SKR_believer_standard", FleetMemberType.SHIP, false);
        ...
        api.addToFleet(FleetSide.PLAYER, "SKR_obelisk_arch", FleetMemberType.SHIP, false);
        ...
        api.addToFleet(FleetSide.PLAYER, "SKR_doctrinaire_standard", FleetMemberType.SHIP, false);

        // Cruisers & Combat Yachts
        api.addToFleet(FleetSide.PLAYER, "SKR_halligan_standard", FleetMemberType.SHIP, false);
        api.addToFleet(FleetSide.PLAYER, "SKR_hedone_deluxe", FleetMemberType.SHIP, false);
        api.addToFleet(FleetSide.PLAYER, "SKR_bullhorn_standard", FleetMemberType.SHIP, false);
        api.addToFleet(FleetSide.PLAYER, "SKR_poisonivy_standard", FleetMemberType.SHIP, false);
        api.addToFleet(FleetSide.PLAYER, "SKR_tumbleweed_standard", FleetMemberType.SHIP, false);
        api.addToFleet(FleetSide.PLAYER, "SKR_clipper_advanced", FleetMemberType.SHIP, false);
        api.addToFleet(FleetSide.PLAYER, "SKR_retiarius_standard", FleetMemberType.SHIP, false);
        api.addToFleet(FleetSide.PLAYER, "SKR_fresnel_standard", FleetMemberType.SHIP, false);
        api.addToFleet(FleetSide.PLAYER, "SKR_trailblazer_assault", FleetMemberType.SHIP, false);
        ...
        api.addToFleet(FleetSide.PLAYER, "SKR_devotee_standard", FleetMemberType.SHIP, false);

        // Battleships, Dreadnoughts & Bosses
        api.addToFleet(FleetSide.PLAYER, "SKR_cassowary_standard", FleetMemberType.SHIP, false);
        api.addToFleet(FleetSide.PLAYER, "SKR_cassowaryRH_assault", FleetMemberType.SHIP, false);
        ...
        api.addToFleet(FleetSide.PLAYER, "SKR_nova_apex", FleetMemberType.SHIP, false);
